...
public:
    ...
    void setupUi(QWidget *MessagePage)
    {
        ...
        MessagePage->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        tableView->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        ...
        backButton->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        QIcon icon;
        ...
        labelContact->setStyleSheet(QStringLiteral(""));
        ...
        listConversation->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        ...
        messageEdit->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);0);"));
        ...
        newButton->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        QIcon icon1;
        ...
        sendButton->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        QIcon icon2;
        ...
        copyFromAddressButton->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        QIcon icon3;
        ...
        copyToAddressButton->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        ...
        deleteButton->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        QIcon icon4;
...
#ifndef QT_NO_TOOLTIP
        sendButton->setToolTip(QApplication::translate("MessagePage", "Sign a message to prove you own an rain address", 0));
#endif // QT_NO_TOOLTIP
