...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        SendCoinsEntry->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        payAmount->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        addAsLabel->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        label1 = new QLabel(SendCoinsEntry);
        ...
        narration->setObjectName(QStringLiteral("narration"));
        narration->setEnabled(true);
        narration->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));

        gridLayout->addWidget(narration, 5, 1, 1, 1);
        ...
        payTo->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
...
#endif // QT_NO_TOOLTIP
        label1->setText(QApplication::translate("SendCoinsEntry", "N&arration:", 0));
#ifndef QT_NO_TOOLTIP
        narration->setToolTip(QApplication::translate("SendCoinsEntry", "Enter a short note to send with payment (max 24 characters)", 0));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("SendCoinsEntry", "&Label:", 0));
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to  (e.g. F96m4dNBqCLh7ZYceQnLG7uPuva5mochZK)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
