...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        openDebugLogfileButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        ...
        showCLOptionsButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        ...
        messagesWidget->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        clearButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        QIcon icon;
        ...
        trafficGraph->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        sldGraphRange->setStyleSheet(QStringLiteral(""));
        ...
        btnClearTrafficGraph->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "rain - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "rain Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the rain debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the rain-qt help message to get a list with possible rain command-line options.", 0));
#endif // QT_NO_TOOLTIP
