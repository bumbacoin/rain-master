...
public:
    ...
    void setupUi(QFrame *SendMessagesEntry)
    {
        ...
        SendMessagesEntry->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        sendTo->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        messageText->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        publicKey->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
