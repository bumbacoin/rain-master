...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        OverviewPage->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        widget->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        ...
        label_5->setStyleSheet(QStringLiteral("color: rgb(0, 85, 127);"));

        horizontalLayout_4->addWidget(label_5);

        labelWalletStatus = new QLabel(widget);
        labelWalletStatus->setObjectName(QStringLiteral("labelWalletStatus"));
        labelWalletStatus->setStyleSheet(QStringLiteral("QLabel { color: #DC143C; }"));
        ...
        label_7->setPixmap(QPixmap(QString::fromUtf8("../../../../Users/dan/Desktop/128.png")));
        ...
        labelBalance->setText(QStringLiteral("0 rain"));
        ...
        labelStake->setStyleSheet(QStringLiteral(""));
        labelStake->setText(QStringLiteral("0 rain"));
        ...
        labelUnconfirmed->setStyleSheet(QLatin1String("color: rgb(229, 0, 0);\n"
""));
        labelUnconfirmed->setText(QStringLiteral("0 rain"));
        ...
        labelImmature->setStyleSheet(QStringLiteral("color: rgb(130, 130, 130);"));
        labelImmature->setText(QStringLiteral("0 rain"));
        ...
        labelTotal->setStyleSheet(QStringLiteral("color: rgb(0, 85, 127);"));
        labelTotal->setText(QStringLiteral("0 rain"));
        ...
        widget_2->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        ...
        label_4->setStyleSheet(QStringLiteral("color: rgb(20, 20, 25);"));
        ...
        labelTransactionsStatus->setStyleSheet(QStringLiteral("QLabel { color: #DC143C; }"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Condensate network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Condensate network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
