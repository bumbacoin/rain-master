...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        newAddressButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        QIcon icon;
        ...
        copyToClipboard->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        QIcon icon1;
        ...
        showQRCode->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        QIcon icon2;
        ...
        signMessage->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        QIcon icon3;
        ...
        verifyMessage->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        QIcon icon4;
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your rain addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0));
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own an rain address", 0));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "Sign &Message", 0));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified rain address", 0));
#endif // QT_NO_TOOLTIP
