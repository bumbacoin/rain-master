...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        tabWidget->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        ...
        proxyIp->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        ...
        proxyPort->setStyleSheet(QStringLiteral("background-color: rgb(223, 191, 191);"));
        ...
        okButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));

        horizontalLayout_Buttons->addWidget(okButton);

        cancelButton = new QPushButton(OptionsDialog);
        cancelButton->setObjectName(QStringLiteral("cancelButton"));
        cancelButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        ...
        applyButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start rain after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Condensation-Qt on system login", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the rain client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the rain network through a SOCKS proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting rain.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show rain addresses in the transaction list or not.", 0));
#endif // QT_NO_TOOLTIP
