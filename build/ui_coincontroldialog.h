...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        CoinControlDialog->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 rain"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 rain"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 rain"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 rain"));
        ...
        pushButtonSelectAll->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
