...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        SendCoinsDialog->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        pushButtonCoinControl->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        ...
        labelCoinControlInsuffFunds->setStyleSheet(QStringLiteral("color:orange;font-weight:bold;"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 828, 162));
        ...
        addButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        QIcon icon;
        ...
        labelBalance->setStyleSheet(QStringLiteral("color: rgb(0, 170, 0);"));
        ...
        sendButton->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        QIcon icon2;
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QApplication::translate("SendCoinsDialog", "0.00 rain", 0));
        ...
        labelCoinControlFee->setText(QApplication::translate("SendCoinsDialog", "0.00 rain", 0));
        ...
        labelCoinControlAfterFee->setText(QApplication::translate("SendCoinsDialog", "0.00 rain", 0));
        labelCoinControlChangeText->setText(QApplication::translate("SendCoinsDialog", "Change", 0));
        labelCoinControlChange->setText(QApplication::translate("SendCoinsDialog", "0.00 rain", 0));
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.4 rain", 0));
#ifndef QT_NO_TOOLTIP
