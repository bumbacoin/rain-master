...
public:
    ...
    void setupUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        SignVerifyMessageDialog->setStyleSheet(QStringLiteral("background-color: rgb(255, 255, 255);"));
        ...
        tabWidget->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        ...
        messageIn_SM->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        ...
        signatureOut_SM->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        ...
        signMessageButton_SM->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        QIcon icon3;
        ...
        clearButton_SM->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        QIcon icon4;
        ...
        addressIn_VM->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        ...
        messageIn_VM->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        ...
        signatureIn_VM->setStyleSheet(QStringLiteral("QListView { background: transparent; }"));
        ...
        verifyMessageButton_VM->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
        QIcon icon5;
        ...
        clearButton_VM->setStyleSheet(QStringLiteral("background-color: rgb(255, 248, 227);"));
    ...
    void retranslateUi(QDialog *SignVerifyMessageDialog)
    {
        ...
        addressIn_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address to sign the message with (e.g. F96m4dNBqCLh7ZYceQnLG7uPuva5mochZK)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        signMessageButton_SM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Sign the message to prove you own this rain address", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        addressIn_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "The address the message was signed with (e.g. F96m4dNBqCLh7ZYceQnLG7uPuva5mochZK)", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        verifyMessageButton_VM->setToolTip(QApplication::translate("SignVerifyMessageDialog", "Verify the message to ensure it was signed with the specified rain address", 0));
#endif // QT_NO_TOOLTIP
