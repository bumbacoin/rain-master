...
Makefile: condensation-qt.pro ../Qt/5.7_static/mkspecs/win32-g++/qmake.conf ../Qt/5.7_static/mkspecs/features/spec_pre.prf \
...
distclean: debug-distclean release-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\rain-master2-master\condensation-qt_plugin_import.cpp .qmake.stash
