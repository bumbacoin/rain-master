...
// Copyright (c) 2014-2015 The rain developers
// Copyright (c) 2015 The rain developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("rain-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("rain-smsg-pow"); // Make this thread recognisable
